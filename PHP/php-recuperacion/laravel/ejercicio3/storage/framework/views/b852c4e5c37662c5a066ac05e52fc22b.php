...
<div style="max-width: 900px; margin: 0 auto;">
    <div style="margin-bottom: 2rem; display: flex; justify-content: space-between; align-items: center;">
        ...
        <div class="action-btns">
            <a href="<?php echo e(route('books.edit', $book->id)); ?>" class="btn btn-outline" style="color: var(--primary); border-color: rgba(139, 92, 246, 0.4);">
    ...
    <div class="card" style="display: grid; grid-template-columns: 1fr 2fr; gap: 3rem; align-items: start;">
        <div class="book-cover-placeholder" style="background: linear-gradient(135deg, #1e293b, #0f172a); aspect-ratio: 2/3; border-radius: 1rem; border: 1px solid var(--border); display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; padding: 2rem; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.3);">
            ...
            <span style="font-weight: 700; color: var(--text-main); font-size: 1.2rem;"><?php echo e($book->title); ?></span>
        </div>
        ...
        <div>
            <div style="margin-bottom: 2rem;">
                ...
                <h2 style="font-size: 2.5rem; margin-bottom: 0.5rem;"><?php echo e($book->title); ?></h2>
                <p style="font-size: 1.25rem; color: var(--text-muted); font-weight: 400;">por <?php echo e($book->author->name); ?></p>
            </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 1.5rem; border-top: 1px solid var(--border); border-bottom: 1px solid var(--border); padding: 1.5rem 0; margin-bottom: 2rem;">
                <div>
                    ...
                    <span style="font-weight: 600; font-size: 1.1rem;"><?php echo e($book->publication_year); ?></span>
                </div>
                <div>
            ...
            <div style="margin-top: 3rem; padding: 2rem; background: rgba(139, 92, 246, 0.05); border-radius: 1rem; border: 1px solid rgba(139, 92, 246, 0.1);">
                ...
                <p style="color: var(--text-muted); font-size: 1rem;"><?php echo e($book->author->biography); ?></p>
            </div>
            <?php endif; ?>
        </div>
    </div>
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/adrian12/Documents/JS-PHP25-26/RECUPERACION/php/laravel/ejercicio3/resources/views/books/show.blade.php ENDPATH**/ ?>