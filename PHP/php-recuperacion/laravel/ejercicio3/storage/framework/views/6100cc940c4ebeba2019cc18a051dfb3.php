    ...
    <div class="card">
        <form action="<?php echo e(route('books.store')); ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" name="publication_year" id="publication_year" min="1000" max="<?php echo e(date('Y')); ?>" placeholder="Ej: 1963" required>
            </div>
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/adrian12/Documents/JS-PHP25-26/RECUPERACION/php/laravel/ejercicio3/resources/views/books/create.blade.php ENDPATH**/ ?>