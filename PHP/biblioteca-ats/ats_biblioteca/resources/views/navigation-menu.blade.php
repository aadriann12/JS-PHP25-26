        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        {{-- Todos los usuarios autenticados ven Libros --}}
                        ...
                        @if(auth()->user()->isLibrarian() || auth()->user()->isAdmin())
                            <x-nav-link href="{{ route('loans.all') }}" :active="request()->routeIs('loans.all')">
                                Gestión préstamos
                            </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
       <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                ...
                @if(auth()->user()->isLibrarian() || auth()->user()->isAdmin())
                    <x-responsive-nav-link href="{{ route('loans.all') }}" :active="request()->routeIs('loans.all')">
                        Gestión préstamos
                    </x-responsive-nav-link>
