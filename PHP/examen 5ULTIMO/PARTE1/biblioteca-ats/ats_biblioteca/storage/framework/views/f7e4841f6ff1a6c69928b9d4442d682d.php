                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <li class="p-4 border rounded-md">
                                ...
                                <div class="mt-3 flex gap-3 text-sm">
                                    <a class="underline" href="<?php echo e(route('categories.show', $category)); ?>">Ver</a>
                                    <a class="underline" href="<?php echo e(route('categories.edit', $category)); ?>">Editar</a>
...
<?php endif; ?>
<?php /**PATH /Users/adrian12/Documents/JS-PHP25-26/PHP/biblioteca-ats/ats_biblioteca/resources/views/categories/index.blade.php ENDPATH**/ ?>