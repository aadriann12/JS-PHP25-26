                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <li class="p-4 border rounded-md">
                                ...
                                <div class="text-sm text-gray-600 mt-1">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($book->published_year): ?> · Año: <?php echo e($book->published_year); ?> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div class="mt-3 flex gap-3 text-sm">
                                    <a class="underline" href="<?php echo e(route('books.show', $book)); ?>">Ver</a>

                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->isLibrarian() || auth()->user()->isAdmin()): ?>
                                    <a class="underline" href="<?php echo e(route('books.edit', $book)); ?>">Editar</a>
...
<?php endif; ?>
<?php /**PATH /Users/adrian12/Documents/JS-PHP25-26/PHP/biblioteca-ats/ats_biblioteca/resources/views/books/index.blade.php ENDPATH**/ ?>